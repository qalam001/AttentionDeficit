...
def build_args():
    ...
    parser.add_argument('--tar_size', default=32, type=int)
    parser.add_argument('--src_sampler', default='uniformg', type=str, choices=['uniformg', 'uniforml', 'random'])
    parser.add_argument('--tar_sampler', default='random', type=str, choices=['uniformg', 'uniforml', 'random'])
    ...
    parser.add_argument('--attack', default='CP', type=str, choices=['IP', 'OP', 'CP', 'SP', 'Att', 'Clean'])
    parser.add_argument('--epoch', default=100, type=int)
    parser.add_argument('--num_batches_train', default=360, type=int)
    parser.add_argument('--num_batches_val', default=40, type=int)
