...
def test(dataset_name='multiviewx'):
    if dataset_name == 'multiviewx':
        ...
        result_fpath = '/home/qalam001/AttentionDeficit/logs/wildtrack/output/test_CP.txt'
        dataset = frameDataset(Wildtrack(os.path.expanduser('/home/qalam001/AttentionDeficit/data/wildtrack')), False, )
    else:
    ...
    for index in [31]:  # tqdm.tqdm(range(len(dataset))):
        ...
        for cam in range(dataset.num_cam):
            ...
            cv2.imwrite(f'/home/qalam001/AttentionDeficit/imgs/cam{cam + 1}.png', img)
