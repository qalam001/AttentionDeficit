...
from AttDefMVDeTr.multiview_detector.models.transformer import TransformerEncoderLayer, TransformerEncoder
from AttDefMVDeTr.multiview_detector.models.deformable_transformer import DeformableTransformerEncoderLayer, \
    DeformableTransformerEncoder
from AttDefMVDeTr.multiview_detector.models.ops.modules import MSDeformAttn
from AttDefMVDeTr.multiview_detector.utils.image_utils import array2heatmap
...
class DeformTransWorldFeat(nn.Module):
    def __init__(self, num_cam, Rworld_shape, base_dim, num_layers=3, n_heads=8, n_points=4,
                 hidden_dim=128, dim_feedforward=512, dropout=0.1, stride=2, reference_points=None):
        ...
        encoder_layer = DeformableTransformerEncoderLayer(hidden_dim, dim_feedforward, dropout,
                                                          n_levels=num_cam, n_heads=n_heads, n_points=n_points)
        self.encoder = DeformableTransformerEncoder(encoder_layer, num_layers, reference_points)
    ...
    def forward(self, x, visualize=False):
        ...
        memory, atts, ptrs = self.encoder(src_flatten, spatial_shapes, level_start_index, valid_ratios, lvl_pos_embed_flatten)
