...
from AttDefMVDeTr.multiview_detector.utils.image_utils import draw_umich_gaussian, random_affine
...
def test(test_projection=False):
    ...
    dataset = frameDataset(Wildtrack(os.path.expanduser('~/wildtrack')), train=True, augmentation=False)
    ...
    if test_projection:
        import matplotlib.pyplot as plt
        from AttDefMVDeTr.multiview_detector.utils.projection import get_worldcoord_from_imagecoord
        world_grid_maps = []
